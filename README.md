...
```js
import { rando, locker, pinto, sortable, particle } from '@balancer-team/rando/presets'
...
particle.generate() //=> "1nMLukngZdML6q1r" (short, sortable, practical for non-distributed systems)
```
